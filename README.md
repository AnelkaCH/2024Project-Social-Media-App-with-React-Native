...
The `isLogin` flag in Redux controlling which navigator renders was probably the most satisfying thing I figured out in this project. Itäs honestlz reallz cool.
